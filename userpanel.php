    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
				...
				<?php
						include ('db.php');
                        $kimino_namay=$_GET['user'];
						$sql = "select * from roombook where FName='$kimino_namay'";
                ...
                <div class="col-md-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table">
									...
									<?php
									$tsql = "select * from roombook where FName='$kimino_namay'";
									...
									{	
										...
										if($co=="Not Conform")
										{
											echo"<tr>
												...
												<th><a href='del.php?rid=".$trow['id']."&user=".$kimino_namay."'class='btn btn-primary'>Delete</a></th>
												</tr>";     
										}
									}
									?>
                      ...
                      <!-- End  Basic Table  --> 
								...
								$rsql = "SELECT * FROM `roombook`WHERE FName='$kimino_namay'";
                                ...
                                <div class="panel panel-info">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse" style="height: 0px;">
                                        <div class="panel-body">
										<?php
										$msql = "SELECT * FROM `roombook` WHERE FName='$kimino_namay'";
										...
										{		
											...
											echo"<div class='col-md-3 col-sm-12 col-xs-12'>
													<div class='panel panel-primary text-center no-boder bg-color-blue'>
														...
														<a href=admin/show.php?sid=".$fid ."><button  class='btn btn-primary btn' data-toggle='modal' data-target='#myModal'>
													Show
													</button></a>
															".$mrow['TRoom']."
														</div>
