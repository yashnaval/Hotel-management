		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<!-- HOTEL NAME -->
					<h1><a class="navbar-brand" href="index.php">Abhi'S<span>Hotel</span><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><?php $user=$_GET['user'];
							$url="userpanel.php?user=".$user;
							echo "<a href='$url'>Hello $user</a>"?></li>									
						</ul>
					</nav>
				</div>
			</nav>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">Abhi's Hotel</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Our Abhi's Hotel</h3> 
						  <p class="about-para-w3ls">An intimate and charming atmosphere, high quality comfort and traditional hospitality.</p>
					...
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								...
								<?php $user=$_GET['user'];
							$url="admin/reservation.php?user=".$user;
							echo "<a href='$url'>Book Now</a>"?>
							</div>
						</div>
					</div>
				</div>
...
<!-- /contact -->
			<div class="copy">
		        <p>Copyright © 2020 : Mini Project </p>
		    </div>
<!--/footer -->
<!-- js -->
